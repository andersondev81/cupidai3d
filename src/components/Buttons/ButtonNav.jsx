...
const ButtonNav = ({ text, onClick }) => {
  ...
  // Atualiza a largura do texto quando o componente é montado ou o texto muda
  useEffect(() => {
    if (textRef.current) {
    ...
    <div className="flex items-center px-4 justify-center">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <span
            ref={textRef} // Referência para calcular a largura
        ...
        <div
          ...
          style={{
            ...
            width: `${textWidth + padding * 2}px`, // Largura baseada no texto + padding extra
            height: "40px",
          }}
        >
          <svg
          ...
          >
            {/* Gradiente de fundo com transição de hover */}
            <path
